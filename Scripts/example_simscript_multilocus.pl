...
#foreach my $ngenes (50) {

foreach my $ngenes(5, 10, 15, 20, 25, 35, 50) {
   ...
   while ( $count < NLOOP1)
   {
       ...
       # JC69 model
       system("./seq-gen < simtrees2.dat > infile -q -mHKY -s 0.001 -l $genelength -p $ngenes");
   ...
   system("sed -f sed.tree.ind alldat.out > alldat_bl1_001_rerun_$ngenes.out");
...
foreach my $ngenes(5, 10, 15, 20, 25, 35, 50) {
   ...
   while ( $count < NLOOP1)
   {
       ...
       # JC69 model
       system("./seq-gen < simtrees2.dat > infile -q -mHKY -s 0.005 -l $genelength -p $ngenes");
   ...
   system("paste bpp_reps.out svdq.out valid.svdq > alldat.out");
   system("sed -f sed.tree.ind alldat.out > alldat_bl1_005_rerun_$ngenes.out");
...
foreach my $ngenes(5, 10, 15, 20, 25, 35, 50) {
   ...
   while ( $count < NLOOP1)
   {
       ...
       # JC69 model
       system("./seq-gen < simtrees2.dat > infile -q -mHKY -s 0.01 -l $genelength -p $ngenes");
   ...
   system("paste bpp_reps.out svdq.out valid.svdq > alldat.out");
   system("sed -f sed.tree.ind alldat.out > alldat_bl1_01_rerun_$ngenes.out");
